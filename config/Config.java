package MppLibraryProject.config;
...
public class Config {
	...
	public static final String OUTPUT_DIR = System.getProperty("user.dir") + SEPARATOR + "src" + SEPARATOR
			+ "MppLibraryProject" + SEPARATOR + "storage";
